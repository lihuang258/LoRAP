...
def get_wikitext2(seq_len, tokenizer):
    traindata = load_from_disk("../dataset/wikitext-2-raw-v1-train")
    testdata = load_from_disk("../dataset/wikitext-2-raw-v1-test")
    # traindata = load_dataset('wikitext', 'wikitext-2-raw-v1', split='train')
    # testdata = load_dataset('wikitext', 'wikitext-2-raw-v1', split='test')
    return traindata, testdata

def get_ptb(seq_len, tokenizer):
    traindata = load_from_disk("/home/liguangyan/pcode/dataset/ptb_text_only/train/")
    valdata = load_from_disk("/home/liguangyan/pcode/dataset/ptb_text_only/validation/")
