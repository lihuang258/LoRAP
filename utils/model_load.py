...
def get_model():
    ...
    parser.add_argument("--dataset", type=str, default="c4", choices=["c4", "PTB", "wikitest2","bookcorpus"],help="Dataset to be used for calibration.")
    ...
    parser.add_argument('--mlp_compress_method', type=str, default="prune", choices=["prune","decom"],help='The method to compress FFN')
    parser.add_argument('--mlp_least_save_ratio', type=float, default=0.01, help='The least important part save ratio of FFN')
    ...
    parser.add_argument("--sublayer", type=str, default=["self_attn", "mlp"], choices=["self_attn", "mlp"],
                        help="Sublayer to be compressed ,you can choose self_attn or mlp individually ")
