...
from utils.data import test_loaders
...
def main(args):
    ...
    # # Load Pruned Model
    pruned_dict = torch.load(args.prune_model)
    ...
    class CustomCallback:
        ...
        def on_step_end(self, args, state, control, **kwargs):
            ...
            if step % self.interval == 0:
                model_parameters = {name: param.data.clone().detach().cpu().numpy() for name, param in
                                    model.named_parameters()}
                print(f"Model parameters at step {step}:", model_parameters)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_dir', type=str, default="tuned_model", help='output directory')
    ...
    # wandb params
    parser.add_argument('--wandb_project', type=str, default="fine-tune")
